...
class BadasoCommentsApiTest extends TestCase
{
    public function test_add_comments()
    {
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->post(CallHelper::getApiV1('/category/add'), $request_data);
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->post(CallHelper::getApiV1('/post/add'), $request_data);
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $response = $this->withHeader('Authorization', "Bearer $token")->json('POST', CallHelper::getApiV1('/comment/add'), $request_data);
            $response->assertSuccessful();
    ...
    public function test_edit_comment()
    {
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->json('PUT', CallHelper::getApiV1('/comment/edit'), $request_data);
        $response->assertSuccessful();
    ...
    public function test_delete_comment()
    {
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->delete(CallHelper::getApiV1('/comment/delete'), [
            'id' => "$tableComment->id",
        ]);
    ...
    {
        $token = CallHelper::login($this);
        $response = $this->get(CallHelper::getApiV1('/comment'));
        $response->assertSuccessful();
    ...
    public function test_post_comment()
    {
        ...
        $response = $this->json('GET', CallHelper::getApiV1('/comment/post'), $requset_data);
        $response->assertSuccessful();
    ...
    public function test_read_comment()
    {
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->json('GET', CallHelper::getApiV1('/comment/read'), $requset_data);
        $response->assertSuccessful();
    ...
    public function test_delete_multiple_comment()
    {
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->delete(CallHelper::getApiV1('/comment/delete-multiple'), [
            'ids' => join(',', $ids),
        ]);
        $response->assertStatus(200);
        ...
        $tablePost = Post::latest()->first();
        $response = $this->withHeader('Authorization', "Bearer $token")->delete(CallHelper::getApiV1('/post/delete'), [
            'id' => "$tablePost->id",
        ]);
        $response->assertSuccessful();
        ...
        $response = $this->withHeader('Authorization', "Bearer $token")->delete(CallHelper::getApiV1('/category/delete'), $id);
        $response->assertSuccessful();
    }
}

...
class PostController extends Controller
{
    ...
    public function read(Request $request)
    {
        try {
            ...
            if ($previous) $data['previous'] = $previous->makeHidden(['content'])->toArray();
            else $data['previous'] = null;

            if ($next) $data['next'] = $next->makeHidden(['content'])->toArray();
            else $data['next'] = null;

            if ($related) $data['related'] = $related->makeHidden(['content'])->toArray();
